...
-(void)shareWitType:(UMSocialPlatformType *)platformType{
    ...
    //创建网页内容对象
     UMShareWebpageObject *shareObject = [UMShareWebpageObject shareObjectWithTitle:@"汇融法"  descr:@"汇融法致力于打造“互联网新生态”律师，平台利用先进的O2O方法，将分散、繁杂的线下法律服务需求及资源整合至线上，为当事人及律师搭建在线沟通、文件传输、公证签约、款项支付以及争端解决等全方位服务的桥梁。" thumImage:[UIImage imageNamed:@"AppIcon"]];
    //设置网页地址
