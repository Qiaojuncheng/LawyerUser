...
static NSInteger const advertScrollViewTitleFont = 16;
...
- (void)layoutSubviews {
    ...
    CGFloat topLabelY = 0;
    CGFloat topLabelW = 200;
    CGFloat topLabelH = 44;
    ...
    CGFloat bottomLabelX = self.frame.size.width ;
     if (self.bottomSignImageView.image == nil) {
        bottomLabelX = CGRectGetMaxX(self.topLabel.frame);
    } else {
        bottomLabelX = CGRectGetMaxX(self.topLabel.frame);
    }
//    CGFloat bottomLabelY = 0;
//    CGFloat bottomLabelW = 60;
//    CGFloat bottomLabelH = 44;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.advertScrollViewStyle == SGAdvertScrollViewStyleMore) {
        ...
        cell.topLabel.text = [NSString stringWithFormat:@"恭喜%@律师收到好评！",self.titleArr[indexPath.item]];
        ...
        cell.bottomLabel.text = [NSString stringWithFormat:@"+%@分",self.bottomTitleArr[indexPath.item]];
        cell.bottomLabel.textColor = [UIColor redColor];
        cell.bottomLabel.frame =CGRectMake(cell.contentView.width - 70, 0, 60, 50);
        
       // [Utile setUILabel:cell.bottomLabel data:[NSString stringWithFormat:@"+%@",self.bottomTitleArr[indexPath.item]] setData:@"分" color:TintColor font:16 underLine:NO];
