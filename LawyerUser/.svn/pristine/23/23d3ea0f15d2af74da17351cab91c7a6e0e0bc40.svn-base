...
- (void)buildUI {
    ...
    for (int i = 0; i < number; i++) {
        ...
        [itemButton setTitleColor:[UIColor colorWithRed:13/255.0 green:122/255.0 blue:189/255.0 alpha:1] forState:UIControlStateSelected];
...
- (UIColor *)tabButtonTitleColorForSelected {
    if (!_tabButtonTitleColorForSelected) {
        _tabButtonTitleColorForSelected = [UIColor colorWithRed:13/255.0 green:122/255.0 blue:189/255.0 alpha:1];
    }
...
- (UIView *)selectedLine {
    if (!_selectedLine) {
        ...
        _selectedLine.backgroundColor = [UIColor colorWithRed:13/255.0 green:122/255.0 blue:189/255.0 alpha:1];
