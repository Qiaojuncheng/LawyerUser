...
-(void)makeData{
    ...
    QJWDXQ
    NSDictionary * valueDic  = @{@"uid":UserId,@"type":[NSString stringWithFormat:@"4"]};
...
-(void)makePongjiaWithNumber:(NSString *)Number Withid:(NSString *)rid{
    ...
    NSDictionary * dic  =[[NSMutableDictionary alloc]init];
    QJMYXQ_PINGJIA
    NSDictionary * valueDic  = @{@"uid":UserId,@"id":rid,@"star":Number,@"type":@"6"};
    NSString * baseStr = [NSString getBase64StringWithArray:valueDic];
    [dic setValue:baseStr forKey:@"value"];
